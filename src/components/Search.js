  ...
  return (
    <div className="bg-[#ececec] w-screen h-screen fixed top-0 left-0 z-10 p-4 overflow-auto">
      <div className="container">
        <div className="flex justify-between items-center py-8 border-b-[2px] border-green-500">
          <h2 className="text-green-500 text-4xl">Pokedex</h2>
          <input
          ...
          />
          <IoMdClose
            className="text-green-500 text-[36px] cursor-pointer"
            onClick={togglePopup}
          />
        </div>
